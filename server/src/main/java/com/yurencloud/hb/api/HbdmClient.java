...
public class HbdmClient {
	...
	public void test(String[] args) throws IOException, HttpException {

		/**
		 * get请求无需发送身份认证,通常用于获取行情，市场深度等公共信息
		 */
		String api_key = "bewr5drtmh-cba4fc40-484891df-2c6e7"; // huobi申请的apiKey
		String secret_key = "af88cc6e-d3ee9000-36bb5468-31de9"; // huobi申请的secretKey
